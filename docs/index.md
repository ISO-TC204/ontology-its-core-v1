...
- [Activation Status Code](classes/ActivationStatusCode.md)
- [Angle](classes/Angle.md)
- [Angle Unit](classes/AngleUnit.md)
...
The formal definition of this ontology is available in [TURTLE Syntax](its-core.ttl).
